 ...
 * メッセージ受信通知COLOR設定.
 */
public enum IncomingMessageColorSetting {
    /** OFF. */
     ...
     */
    IncomingMessageColorSetting(int code, @StringRes int label) {
        this.code = code;
        this.label = label;
    }
     ...
     *
     * @param code プロトコルでの定義値
     * @return プロトコルでの定義値に該当するIncomingMessageColorSetting
     * @throws IllegalArgumentException プロトコルでの定義値に該当するものがない
     */
    public static IncomingMessageColorSetting valueOf(byte code) {
        for (IncomingMessageColorSetting value : values()) {
