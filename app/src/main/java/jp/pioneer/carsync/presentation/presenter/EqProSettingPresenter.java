...
/**
 * EQ Pro SettingのPresenter
 */
@PresenterLifeCycle
public class EqProSettingPresenter extends Presenter<EqProSettingView>{
...
//        System.arraycopy(bands,0,bandSetting.bands,0,bands.length);
    ...
    public void onZoomAction(){
        ...
        mEventBus.post(new NavigateEvent(ScreenId.EQ_PRO_SETTING_ZOOM, args));
    }
