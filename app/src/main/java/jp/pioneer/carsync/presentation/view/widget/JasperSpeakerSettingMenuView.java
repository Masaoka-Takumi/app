...
public class JasperSpeakerSettingMenuView extends FrameLayout {
    ...
    public JasperSpeakerSettingMenuView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init(context, attrs, defStyleAttr);
    }

    public JasperSpeakerSettingMenuView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    public JasperSpeakerSettingMenuView(Context context, AttributeSet attrs) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        View root = inflate(context, R.layout.widget_jasper_speaker_setting_menu, this);
