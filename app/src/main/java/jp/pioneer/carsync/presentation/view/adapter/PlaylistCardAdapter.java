...
public class PlaylistCardAdapter extends AbstractCardAdapter {

    private PlaylistAdapter mCursorAdapter;
     ...
     * @param c       カーソル
     */
    public PlaylistCardAdapter(Context context, Cursor c) {
        super(context);
        mCursorAdapter = new PlaylistAdapter(mContext, c) {
            @Override
            ...
            public void bindView(View view, Context context, Cursor cursor) {
                PlaylistCardAdapter.ViewHolder holder = (PlaylistCardAdapter.ViewHolder) view.getTag();
                long id = AppMusicContract.Playlist.getId(cursor);
                holder.title.setText(AppMusicContract.Playlist.getName(cursor));
