 ...
 * #406 getView() 繰り返し 呼ばれる対策（暫） by nakano on 2016/06/28
 * caused by VerticalViewPager.onLayout:child.layout
 */
public class GridSpeakerSettingMenuAdapter extends SpeakerSettingMenuAdapter {
    ...
    public GridSpeakerSettingMenuAdapter(Context context, String name, ColorStateList buttonBackgroundTint, ColorStateList currentValueTextColor) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        GridSpeakerSettingMenuItemView v = (GridSpeakerSettingMenuItemView) convertView;
