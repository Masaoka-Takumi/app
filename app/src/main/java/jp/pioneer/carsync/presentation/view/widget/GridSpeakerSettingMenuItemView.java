...
/**
 * Created by nakano on 6/20/2016.
 */
public class GridSpeakerSettingMenuItemView extends FrameLayout {
    ...
    public GridSpeakerSettingMenuItemView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes,
    ...
    public GridSpeakerSettingMenuItemView(Context context, AttributeSet attrs, int defStyleAttr,
                                          SpeakerSettingMenuAdapter.SpeakerSettingMenuType type, SpeakerSettingMenuAdapter.SpeakerSettingMenuType type2) {
    ...
    public GridSpeakerSettingMenuItemView(Context context, AttributeSet attrs,
                                          SpeakerSettingMenuAdapter.SpeakerSettingMenuType type, SpeakerSettingMenuAdapter.SpeakerSettingMenuType type2) {
        this(context, attrs, 0, type, type2);
    }

    public GridSpeakerSettingMenuItemView(Context context,
                                          SpeakerSettingMenuAdapter.SpeakerSettingMenuType type, SpeakerSettingMenuAdapter.SpeakerSettingMenuType type2) {
        this(context, null, type, type2);
    }

    public GridSpeakerSettingMenuItemView(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    public GridSpeakerSettingMenuItemView(@NonNull Context context) {
        this(context, null, SpeakerSettingMenuAdapter.SpeakerSettingMenuType.EMPTY, SpeakerSettingMenuAdapter.SpeakerSettingMenuType.EMPTY);
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (mSpeakerSettingMenuType == SpeakerSettingMenuAdapter.SpeakerSettingMenuType.HPF_CUTOFF) {
            ...
            if (mSpeakerSettingMenuType2 == SpeakerSettingMenuAdapter.SpeakerSettingMenuType.EMPTY) {
                resource = R.layout.widget_speaker_setting_menu_item_single;
            } else {
        ...
        public void onTouchStateChanged(AutoRepeatButton v, int newState, int oldState) {
            ...
            if (listener != null) {
                if (newState == AutoRepeatButton.STATE_OPENING) {
                    ...
                    requestDisallowInterceptTouchEvent(false);
                    //17-271-1-01033::設定無効に変更時に車載器に設定変更通知を送らないようにする
