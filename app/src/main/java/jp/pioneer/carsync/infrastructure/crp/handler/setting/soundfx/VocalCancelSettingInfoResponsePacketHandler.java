...
/**
 * Vocal Cancel設定情報応答パケットハンドラ.
 */
public class VocalCancelSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
    private CarRemoteSession mSession;
    private VocalCancelSettingInfoPacketProcessor mPacketProcessor;
     ...
     */
    public VocalCancelSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
        mSession = checkNotNull(session);
        mPacketProcessor = new VocalCancelSettingInfoPacketProcessor(session.getStatusHolder());
    }
