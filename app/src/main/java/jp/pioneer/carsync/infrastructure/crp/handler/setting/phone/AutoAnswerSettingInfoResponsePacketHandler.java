...
/**
 * AUTO ANSWER設定情報応答パケットハンドラ.
 */
public class AutoAnswerSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public AutoAnswerSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
