 ...
 * ALC設定情報通知パケットハンドラ.
 */
public class AlcSettingInfoNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public AlcSettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
