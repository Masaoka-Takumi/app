...
public class EbuCompleteConverter {
    private static final SparseArray<String> sCharacters = new SparseArray<>(255);
    static {
        sCharacters.put(0x01, String.valueOf(Character.toChars(0x0118)));
        sCharacters.put(0x02, String.valueOf(Character.toChars(0x012E)));
        sCharacters.put(0x03, String.valueOf(Character.toChars(0x0172)));
        sCharacters.put(0x04, String.valueOf(Character.toChars(0x0102)));
        sCharacters.put(0x05, String.valueOf(Character.toChars(0x0116)));
        sCharacters.put(0x06, String.valueOf(Character.toChars(0x010E)));
        sCharacters.put(0x07, String.valueOf(Character.toChars(0x0218)));
        sCharacters.put(0x08, String.valueOf(Character.toChars(0x021A)));
        sCharacters.put(0x09, String.valueOf(Character.toChars(0x010A)));
        sCharacters.put(0x0a, "");
        sCharacters.put(0x0b, "");
        sCharacters.put(0x0c, String.valueOf(Character.toChars(0x0120)));
        sCharacters.put(0x0d, String.valueOf(Character.toChars(0x0139)));
        sCharacters.put(0x0e, String.valueOf(Character.toChars(0x017B)));
        sCharacters.put(0x0f, String.valueOf(Character.toChars(0x0143)));

        sCharacters.put(0x10, String.valueOf(Character.toChars(0x0105)));
        sCharacters.put(0x11, String.valueOf(Character.toChars(0x0119)));
        sCharacters.put(0x12, String.valueOf(Character.toChars(0x012F)));
        sCharacters.put(0x13, String.valueOf(Character.toChars(0x0173)));
        sCharacters.put(0x14, String.valueOf(Character.toChars(0x0103)));
        sCharacters.put(0x15, String.valueOf(Character.toChars(0x0117)));
        sCharacters.put(0x16, String.valueOf(Character.toChars(0x010F)));
        sCharacters.put(0x17, String.valueOf(Character.toChars(0x0219)));
        sCharacters.put(0x18, String.valueOf(Character.toChars(0x021B)));
        sCharacters.put(0x19, String.valueOf(Character.toChars(0x010B)));
        sCharacters.put(0x1a, String.valueOf(Character.toChars(0x0147)));
        sCharacters.put(0x1b, String.valueOf(Character.toChars(0x011A)));
        sCharacters.put(0x1c, String.valueOf(Character.toChars(0x0121)));
        sCharacters.put(0x1d, String.valueOf(Character.toChars(0x013A)));
        sCharacters.put(0x1e, String.valueOf(Character.toChars(0x017C)));
        sCharacters.put(0x1f, "");
        ...
        sCharacters.put(0x24, String.valueOf(Character.toChars(0x0142)));
        ...
        sCharacters.put(0x5c, String.valueOf(Character.toChars(0x016E)));
        sCharacters.put(0x5d, String.valueOf(Character.toChars(0x005D)));
        sCharacters.put(0x5e, String.valueOf(Character.toChars(0x0141)));
        sCharacters.put(0x5f, String.valueOf(Character.toChars(0x005F)));

        sCharacters.put(0x60, String.valueOf(Character.toChars(0x0104)));
        ...
        sCharacters.put(0x7b, String.valueOf(Character.toChars(0x00AB)));
        sCharacters.put(0x7c, String.valueOf(Character.toChars(0x016F)));
        sCharacters.put(0x7d, String.valueOf(Character.toChars(0x00BB)));
        sCharacters.put(0x7e, String.valueOf(Character.toChars(0x013D)));
        sCharacters.put(0x7f, String.valueOf(Character.toChars(0x0126)));
        ...
        sCharacters.put(0x8f, String.valueOf(Character.toChars(0x0178)));
        ...
        sCharacters.put(0x9f, String.valueOf(Character.toChars(0x00FF)));

        sCharacters.put(0xa0, String.valueOf(Character.toChars(0x0136)));
        sCharacters.put(0xa1, String.valueOf(Character.toChars(0x0145)));
        sCharacters.put(0xa2, String.valueOf(Character.toChars(0x00A9)));
        sCharacters.put(0xa3, String.valueOf(Character.toChars(0x0122)));
        ...
        sCharacters.put(0xa8, String.valueOf(Character.toChars(0x0150)));
        ...
        sCharacters.put(0xac, String.valueOf(Character.toChars(0x0100)));
        sCharacters.put(0xad, String.valueOf(Character.toChars(0x0112)));
        sCharacters.put(0xae, String.valueOf(Character.toChars(0x012A)));
        sCharacters.put(0xaf, String.valueOf(Character.toChars(0x016A)));

        sCharacters.put(0xb0, String.valueOf(Character.toChars(0x0137)));
        sCharacters.put(0xb1, String.valueOf(Character.toChars(0x0146)));
        sCharacters.put(0xb2, String.valueOf(Character.toChars(0x013B)));
        sCharacters.put(0xb3, String.valueOf(Character.toChars(0x0123)));
        sCharacters.put(0xb4, String.valueOf(Character.toChars(0x013C)));
        ...
        sCharacters.put(0xb8, String.valueOf(Character.toChars(0x0170)));
        sCharacters.put(0xb9, String.valueOf(Character.toChars(0x00BF)));
        sCharacters.put(0xba, String.valueOf(Character.toChars(0x013E)));
        sCharacters.put(0xbb, String.valueOf(Character.toChars(0x00B0)));
        sCharacters.put(0xbc, String.valueOf(Character.toChars(0x0101)));
        sCharacters.put(0xbd, String.valueOf(Character.toChars(0x0113)));
        sCharacters.put(0xbe, String.valueOf(Character.toChars(0x012B)));
        sCharacters.put(0xbf, String.valueOf(Character.toChars(0x016B)));
        ...
        sCharacters.put(0xee, String.valueOf(Character.toChars(0x0164)));
        ...
        sCharacters.put(0xfe, String.valueOf(Character.toChars(0x0165)));
        sCharacters.put(0xff, String.valueOf(Character.toChars(0x0127)));
    }
    ...
    public static String writeAllString() {
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i <= sCharacters.size(); i++) {
            if(i%16==0){
                sb.append("\n");
            }
            sb.append(sCharacters.get(i));
        }
        return sb.toString();
    }
}
