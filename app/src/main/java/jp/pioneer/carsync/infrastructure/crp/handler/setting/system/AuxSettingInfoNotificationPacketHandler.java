 ...
 * AUX設定情報通知パケットハンドラ.
 */
public class AuxSettingInfoNotificationPacketHandler extends AbstractPacketHandler {
    private AuxSettingInfoPacketProcessor mPacketProcessor;
     ...
     */
    public AuxSettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
        mPacketProcessor = new AuxSettingInfoPacketProcessor(session.getStatusHolder());
    }
