...
/**
 * ステアリングリモコン設定情報通知パケットハンドラ.
 */
public class SteeringRemoteControlSettingInfoNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public SteeringRemoteControlSettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
