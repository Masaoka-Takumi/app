...
/**
 * KEY COLOR一括情報応答パケットハンドラ.
 */
public class KeyColorBulkSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public KeyColorBulkSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
    ...
    public void handle(@NonNull IncomingPacket packet) throws Exception {
        try {
            ...
            IlluminationColorMap colorMap = illuminationSetting.keyColorSpec;
            // D1-D3:WHITE
            ...
            Timber.d("handle() KeyColorSpec = " + colorMap);
