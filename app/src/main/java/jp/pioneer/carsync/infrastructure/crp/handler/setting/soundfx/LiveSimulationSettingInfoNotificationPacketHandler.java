...
/**
 * ライブシミュレーション設定情報通知パケットハンドラ.
 */
public class LiveSimulationSettingInfoNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public LiveSimulationSettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
