...
/**
 * LISTENING POSITION設定情報応答パケットハンドラ.
 */
public class ListeningPositionSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
    private CarRemoteSession mSession;
    private ListeningPositionSettingInfoPacketProcessor mPacketProcessor;
     ...
     */
    public ListeningPositionSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
        mSession = checkNotNull(session);
        mPacketProcessor = new ListeningPositionSettingInfoPacketProcessor(session.getStatusHolder());
    }
