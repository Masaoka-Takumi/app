...
/**
 * BT PHONE COLOR設定情報応答パケットハンドラ.
 */
public class BtPhoneColorSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public BtPhoneColorSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
