...
/**
 * BT Audio設定情報通知パケットハンドラ.
 */
public class BtAudioSettingInfoNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public BtAudioSettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
