...
/**
 * ATT/MUTE設定情報通知パケットハンドラ.
 */
public class AttMuteSettingInfoNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public AttMuteSettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
