...
/**
 * AUTO PAIRING設定情報応答パケットハンドラ.
 */
public class AutoPairingSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public AutoPairingSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
