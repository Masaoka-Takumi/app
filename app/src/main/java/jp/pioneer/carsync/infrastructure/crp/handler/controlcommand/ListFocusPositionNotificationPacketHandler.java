 ...
 * フォーカス位置通知パケットハンドラ.
 */
public class ListFocusPositionNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public ListFocusPositionNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
