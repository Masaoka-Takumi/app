 ...
 * Super轟設定情報パケットプロセッサ.
 * <p>
 * Super轟設定情報応答と通知で使用する。
 */
public class SuperTodorokiSettingInfoPacketProcessor {
     ...
     */
    public SuperTodorokiSettingInfoPacketProcessor(@NonNull StatusHolder statusHolder) {
    ...
    public Boolean process(@NonNull IncomingPacket packet) {
        try {
            ...
            // D1:Super轟設定
            soundFxSetting.superTodorokiSetting = SuperTodorokiSetting.valueOf(data[1]);

            soundFxSetting.updateVersion();
            Timber.d("process() SuperTodorokiSetting = " + soundFxSetting.superTodorokiSetting);
            return Boolean.TRUE;
