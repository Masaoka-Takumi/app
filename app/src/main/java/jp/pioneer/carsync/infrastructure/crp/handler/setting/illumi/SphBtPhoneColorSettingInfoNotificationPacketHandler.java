...
/**
 * [SPH] BT PHONE COLOR設定情報通知パケットハンドラ.
 */
public class SphBtPhoneColorSettingInfoNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public SphBtPhoneColorSettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
