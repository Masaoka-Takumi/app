...
/**
 * Auto EQ補正設定情報パケットプロセッサ.
 * <p>
 * Auto EQ補正設定情報応答と通知で使用する。
 */
public class AutoEqCorrectionSettingInfoPacketProcessor {
     ...
     */
    public AutoEqCorrectionSettingInfoPacketProcessor(@NonNull StatusHolder statusHolder) {
    ...
    public Boolean process(@NonNull IncomingPacket packet) {
        try {
            ...
            // D1:設定値
            audioSetting.autoEqCorrectionSetting = AutoEqCorrectionSetting.valueOf(data[1]);

            audioSetting.updateVersion();
            Timber.d("process() AutoEqCorrectionSetting = " + audioSetting.autoEqCorrectionSetting);
            return Boolean.TRUE;
