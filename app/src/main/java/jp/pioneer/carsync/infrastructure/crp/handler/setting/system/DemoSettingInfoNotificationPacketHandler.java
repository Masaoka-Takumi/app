 ...
 * DEMO設定情報通知パケットハンドラ.
 */
public class DemoSettingInfoNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public DemoSettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
