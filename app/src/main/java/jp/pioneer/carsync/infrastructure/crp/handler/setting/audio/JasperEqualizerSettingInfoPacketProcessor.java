...
/**
 * [JASPER] EQ設定情報パケットプロセッサ.
 * <p>
 * [JASPER] EQ設定情報応答と通知で使用する。
 */
public class JasperEqualizerSettingInfoPacketProcessor {
     ...
     */
    public JasperEqualizerSettingInfoPacketProcessor(@NonNull StatusHolder statusHolder) {
