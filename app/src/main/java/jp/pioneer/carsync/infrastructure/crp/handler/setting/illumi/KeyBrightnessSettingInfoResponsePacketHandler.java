...
/**
 * KEY BRIGHTNESS設定情報応答（個別設定モデル用）パケットハンドラ.
 */
public class KeyBrightnessSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public KeyBrightnessSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
