...
/**
 * Function設定情報応答パケットハンドラ.
 */
public class FunctionSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public FunctionSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
