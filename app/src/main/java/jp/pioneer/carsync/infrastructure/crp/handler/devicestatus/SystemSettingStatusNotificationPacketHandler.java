...
/**
 * システム設定ステータス情報通知パケットハンドラ.
 */
public class SystemSettingStatusNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public SystemSettingStatusNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
    ...
    protected OutgoingPacket doHandle(@NonNull IncomingPacket packet) throws Exception {
        ...
        return getPacketBuilder().createSystemSettingStatusNotificationResponse();
    }
}
