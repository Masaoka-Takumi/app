...
/**
 * バック信号極性設定情報通知パケットハンドラ.
 */
public class BackPolaritySettingInfoNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public BackPolaritySettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
