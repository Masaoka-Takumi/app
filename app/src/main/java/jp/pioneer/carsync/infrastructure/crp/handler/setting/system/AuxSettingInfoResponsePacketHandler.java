 ...
 * AUX設定情報応答パケットハンドラ.
 */
public class AuxSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public AuxSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
