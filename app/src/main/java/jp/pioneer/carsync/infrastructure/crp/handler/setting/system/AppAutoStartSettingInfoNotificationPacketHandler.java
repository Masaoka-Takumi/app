...
/**
 * 99APP自動起動設定情報通知パケットハンドラ.
 */
public class AppAutoStartSettingInfoNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public AppAutoStartSettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
