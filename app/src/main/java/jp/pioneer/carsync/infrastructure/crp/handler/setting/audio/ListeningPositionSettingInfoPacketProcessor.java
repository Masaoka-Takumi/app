...
/**
 * LISTENING POSITION設定情報パケットプロセッサ.
 * <p>
 * LISTENING POSITION設定情報応答と通知で使用する。
 */
public class ListeningPositionSettingInfoPacketProcessor {
     ...
     */
    public ListeningPositionSettingInfoPacketProcessor(@NonNull StatusHolder statusHolder) {
    ...
    public Boolean process(@NonNull IncomingPacket packet) {
        try {
            ...
            // D1:設定値
            audioSetting.listeningPositionSetting = ListeningPositionSetting.valueOf(data[1]);

            audioSetting.updateVersion();
            Timber.d("process() ListeningPositionSetting = " + audioSetting.listeningPositionSetting);
            return Boolean.TRUE;
