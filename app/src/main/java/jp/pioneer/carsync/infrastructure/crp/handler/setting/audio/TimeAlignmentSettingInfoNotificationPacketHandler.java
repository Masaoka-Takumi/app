...
/**
 * TIME ALIGNMENT情報通知パケットハンドラ.
 */
public class TimeAlignmentSettingInfoNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public TimeAlignmentSettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
