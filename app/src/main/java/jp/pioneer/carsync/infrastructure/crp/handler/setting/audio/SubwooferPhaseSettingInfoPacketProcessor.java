...
/**
 * SUBWOOFER位相設定情報パケットプロセッサ.
 * <p>
 * SUBWOOFER位相設定情報応答と通知で使用する。
 */
public class SubwooferPhaseSettingInfoPacketProcessor {
     ...
     */
    public SubwooferPhaseSettingInfoPacketProcessor(@NonNull StatusHolder statusHolder) {
    ...
    public Boolean process(@NonNull IncomingPacket packet) {
        try {
            ...
            // D1:設定値
            audioSetting.subwooferPhaseSetting = SubwooferPhaseSetting.valueOf(data[1]);

            audioSetting.updateVersion();
            Timber.d("process() SubwooferPhaseSetting = " + audioSetting.subwooferPhaseSetting);
            return Boolean.TRUE;
