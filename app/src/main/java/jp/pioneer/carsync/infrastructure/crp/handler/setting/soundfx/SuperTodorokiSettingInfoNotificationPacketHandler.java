...
/**
 * Super轟設定情報通知パケットハンドラ.
 */
public class SuperTodorokiSettingInfoNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public SuperTodorokiSettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
