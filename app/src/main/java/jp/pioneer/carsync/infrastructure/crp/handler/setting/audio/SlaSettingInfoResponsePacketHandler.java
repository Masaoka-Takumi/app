 ...
 * SLA設定情報応答パケットハンドラ.
 */
public class SlaSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public SlaSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
