...
/**
 * BASS BOOSTERレベル設定情報応答パケットハンドラ.
 */
public class BassBoosterLevelSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public BassBoosterLevelSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
