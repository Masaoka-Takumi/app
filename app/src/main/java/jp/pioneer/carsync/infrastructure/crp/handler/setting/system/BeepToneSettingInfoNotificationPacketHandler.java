...
/**
 * BEEP TONE設定情報通知パケットハンドラ.
 */
public class BeepToneSettingInfoNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public BeepToneSettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
        mPacketProcessor = new BeepToneSettingInfoPacketProcessor(session.getStatusHolder());
    }
