 ...
 * カラオケ設定情報通知パケットハンドラ.
 */
public class KaraokeSettingInfoNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public KaraokeSettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
