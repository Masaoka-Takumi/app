...
/**
 * BRIGHTNESS設定情報応答（共通設定モデル用）パケットハンドラ.
 */
public class BrightnessSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
    private CarRemoteSession mSession;
    private BrightnessSettingInfoPacketProcessor mPacketProcessor;
     ...
     */
    public BrightnessSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
        mSession = checkNotNull(session);
        mPacketProcessor = new BrightnessSettingInfoPacketProcessor(session.getStatusHolder());
    }
