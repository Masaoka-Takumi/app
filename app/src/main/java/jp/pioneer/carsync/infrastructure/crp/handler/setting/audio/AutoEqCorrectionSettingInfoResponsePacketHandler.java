...
/**
 * Auto EQ補正設定情報応答パケットハンドラ.
 */
public class AutoEqCorrectionSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public AutoEqCorrectionSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
