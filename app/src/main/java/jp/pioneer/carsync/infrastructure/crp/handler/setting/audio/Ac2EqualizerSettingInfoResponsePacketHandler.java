...
/**
 * [AC2] EQ設定情報応答パケットハンドラ.
 */
public class Ac2EqualizerSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
    private CarRemoteSession mSession;
    private Ac2EqualizerSettingInfoPacketProcessor mPacketProcessor;
     ...
     */
    public Ac2EqualizerSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
        mSession = checkNotNull(session);
        mPacketProcessor = new Ac2EqualizerSettingInfoPacketProcessor(session.getStatusHolder());
    }
