...
/**
 * DISP BRIGHTNESS設定情報応答（個別設定モデル用）パケットハンドラ.
 */
public class DisplayBrightnessSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
    private CarRemoteSession mSession;
    private DisplayBrightnessSettingInfoPacketProcessor mPacketProcessor;
     ...
     */
    public DisplayBrightnessSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
        mSession = checkNotNull(session);
        mPacketProcessor = new DisplayBrightnessSettingInfoPacketProcessor(session.getStatusHolder());
    }
