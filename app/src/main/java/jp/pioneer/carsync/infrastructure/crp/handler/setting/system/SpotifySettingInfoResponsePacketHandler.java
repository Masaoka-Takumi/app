...
/**
 * Spotify設定情報応答パケットハンドラ.
 */
public class SpotifySettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public SpotifySettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
