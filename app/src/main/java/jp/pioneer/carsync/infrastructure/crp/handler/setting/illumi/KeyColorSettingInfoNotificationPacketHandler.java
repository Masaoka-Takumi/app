...
/**
 * KEY COLOR設定情報通知パケットハンドラ.
 */
public class KeyColorSettingInfoNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public KeyColorSettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
