...
/**
 * 初期設定ステータス情報応答パケットハンドラ.
 */
public class InitialSettingStatusResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public InitialSettingStatusResponsePacketHandler(@NonNull CarRemoteSession session) {
