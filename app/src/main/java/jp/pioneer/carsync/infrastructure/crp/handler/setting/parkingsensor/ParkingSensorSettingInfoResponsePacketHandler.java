...
/**
 * パーキングセンサー設定情報応答パケットハンドラ.
 */
public class ParkingSensorSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public ParkingSensorSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
