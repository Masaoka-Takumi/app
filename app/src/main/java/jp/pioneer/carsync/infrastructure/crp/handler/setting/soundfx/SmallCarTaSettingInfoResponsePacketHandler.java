...
/**
 * Small Car TA設定情報応答パケットハンドラ.
 */
public class SmallCarTaSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public SmallCarTaSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
