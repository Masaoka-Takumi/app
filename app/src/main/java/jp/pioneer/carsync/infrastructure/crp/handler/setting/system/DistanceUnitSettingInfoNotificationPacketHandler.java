 ...
 * 距離単位設定情報通知パケットハンドラ.
 */
public class DistanceUnitSettingInfoNotificationPacketHandler extends AbstractPacketHandler {
     ...
     */
    public DistanceUnitSettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
