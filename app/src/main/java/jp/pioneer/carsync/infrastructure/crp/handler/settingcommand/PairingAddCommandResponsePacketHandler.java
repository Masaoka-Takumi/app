...
/**
 * ペアリング追加コマンド通知応答パケットハンドラ.
 * <p>
 * 応答を知らせるのみの通知のため、{@link #getResult()}は常に{@link Boolean#TRUE}となる。
 */
public class PairingAddCommandResponsePacketHandler extends ResponsePacketHandler<Boolean> {
    /**
     * コンストラクタ.
     *
     * @param session CarRemoteSession
     */
    public PairingAddCommandResponsePacketHandler(@NonNull CarRemoteSession session) {
    }
