...
/**
 * 警告音出力先設定情報応答パケットハンドラ.
 */
public class AlarmOutputDestinationSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public AlarmOutputDestinationSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
