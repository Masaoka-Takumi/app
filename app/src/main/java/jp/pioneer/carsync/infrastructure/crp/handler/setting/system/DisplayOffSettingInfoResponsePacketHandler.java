...
/**
 * DISP OFF設定情報応答パケットハンドラ.
 */
public class DisplayOffSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public DisplayOffSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
