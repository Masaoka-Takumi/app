 ...
 * SLA設定情報通知パケットハンドラ.
 */
public class SlaSettingInfoNotificationPacketHandler extends AbstractPacketHandler {
    private SlaSettingInfoPacketProcessor mPacketProcessor;
     ...
     */
    public SlaSettingInfoNotificationPacketHandler(@NonNull CarRemoteSession session) {
        super(session);
        mPacketProcessor = new SlaSettingInfoPacketProcessor(session.getStatusHolder());
    }
