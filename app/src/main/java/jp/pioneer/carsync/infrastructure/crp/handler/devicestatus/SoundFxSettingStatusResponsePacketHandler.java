...
/**
 * Sound FX設定ステータス情報応答パケットハンドラ.
 */
public class SoundFxSettingStatusResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public SoundFxSettingStatusResponsePacketHandler(@NonNull CarRemoteSession session) {
