...
/**
 * SOUND RETRIEVER設定情報パケットプロセッサ.
 * <p>
 * SOUND RETRIEVER設定情報応答と通知で使用する。
 */
public class SoundRetrieverSettingInfoPacketProcessor {
     ...
     */
    public SoundRetrieverSettingInfoPacketProcessor(@NonNull StatusHolder statusHolder) {
    ...
    public Boolean process(@NonNull IncomingPacket packet) {
        try {
            ...
            // D1:設定値
            audioSetting.soundRetrieverSetting = SoundRetrieverSetting.valueOf(data[1]);

            audioSetting.updateVersion();
            Timber.d("process() SoundRetrieverSetting = " + audioSetting.soundRetrieverSetting);
            return Boolean.TRUE;
