...
public class DemoSettingInfoPacketProcessor {
     ...
     */
    public DemoSettingInfoPacketProcessor(@NonNull StatusHolder statusHolder) {
    ...
    public Boolean process(@NonNull IncomingPacket packet) {
        try {
            ...
            // D1:DEMO設定
            setting.demoSetting = (ubyteToInt(data[1]) == 0x01);

            setting.updateVersion();
            Timber.d("process() DemoSetting = " + setting.demoSetting);
            return Boolean.TRUE;
