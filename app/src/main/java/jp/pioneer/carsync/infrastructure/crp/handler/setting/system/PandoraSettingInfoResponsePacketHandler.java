...
/**
 * Pandora設定情報応答パケットハンドラ.
 */
public class PandoraSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public PandoraSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
