...
/**
 * [AC2] LEVEL設定情報応答パケットハンドラ.
 */
public class LevelSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public LevelSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
