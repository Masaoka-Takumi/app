...
/**
 * Rear出力設定情報応答パケットハンドラ.
 */
public class RearOutputSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public RearOutputSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
