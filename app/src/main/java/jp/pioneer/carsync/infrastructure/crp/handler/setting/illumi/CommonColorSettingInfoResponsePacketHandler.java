...
/**
 * COLOR設定情報(共通設定モデル用)応答パケットハンドラ.
 */
public class CommonColorSettingInfoResponsePacketHandler extends DataResponsePacketHandler {
     ...
     */
    public CommonColorSettingInfoResponsePacketHandler(@NonNull CarRemoteSession session) {
