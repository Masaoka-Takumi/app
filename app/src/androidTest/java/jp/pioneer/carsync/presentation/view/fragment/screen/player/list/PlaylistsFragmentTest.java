...
public class PlaylistsFragmentTest {
    ...
    public interface TestAppComponent extends AppComponent {
        PlaylistsFragmentTest.TestPresenterComponent presenterComponent(PlaylistsFragmentTest.TestPresenterModule module);
    }

    @PresenterLifeCycle
    @Subcomponent(modules = PlaylistsFragmentTest.TestPresenterModule.class)
    ...
    public void setUp() throws Exception {
        ...
        PlaylistsFragmentTest.TestAppComponent appComponent = DaggerPlaylistsFragmentTest_TestAppComponent.builder().build();
        testApp.setAppComponent(appComponent);
        testApp.setComponentFactory(mComponentFactory);
        PlaylistsFragmentTest.TestPresenterComponent presenterComponent = appComponent.presenterComponent(new PlaylistsFragmentTest.TestPresenterModule());
        ...
        when(mComponentFactory.createFragmentComponent(any(PlaylistsFragmentTest.TestPresenterComponent.class), any(PlaylistsFragment.class))).thenReturn(fragmentComponent);
    ...
    public void testSetAlbumCursor2() throws Exception {
        when(mPresenter.isPlaylistCardEnabled()).thenReturn(true);
        mFragmentRule.launchActivity(null);
        final PlaylistsFragment fragment = mFragmentRule.getFragment();
        Bundle args = new Bundle();
        Instrumentation instr = InstrumentationRegistry.getInstrumentation();
