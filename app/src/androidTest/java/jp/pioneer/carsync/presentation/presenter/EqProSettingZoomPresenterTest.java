...
/**
 * EQ Pro Setting ZoomのPresenterのテスト
 */
public class EqProSettingZoomPresenterTest {
    @Rule public MockitoRule mMockito = MockitoJUnit.rule();
    @InjectMocks EqProSettingZoomPresenter mPresenter = new EqProSettingZoomPresenter();
    @Mock EqProSettingZoomView mView;
