...
public class AlbumsFragmentTest {
    ...
    public interface TestAppComponent extends AppComponent {
        AlbumsFragmentTest.TestPresenterComponent presenterComponent(AlbumsFragmentTest.TestPresenterModule module);
    }

    @PresenterLifeCycle
    @Subcomponent(modules = AlbumsFragmentTest.TestPresenterModule.class)
    ...
    public void setUp() throws Exception {
        ...
        AlbumsFragmentTest.TestAppComponent appComponent = DaggerAlbumsFragmentTest_TestAppComponent.builder().build();
        testApp.setAppComponent(appComponent);
        testApp.setComponentFactory(mComponentFactory);
        AlbumsFragmentTest.TestPresenterComponent presenterComponent = appComponent.presenterComponent(new AlbumsFragmentTest.TestPresenterModule());
        ...
        when(mComponentFactory.createFragmentComponent(any(AlbumsFragmentTest.TestPresenterComponent.class), any(AlbumsFragment.class))).thenReturn(fragmentComponent);
...
//            fragment.setDirectoryPass("pass");
    ...
    public void testSetAlbumCursor2() throws Exception {
        when(mPresenter.isAlbumArtEnabled()).thenReturn(true);
        mFragmentRule.launchActivity(null);
        final AlbumsFragment fragment = mFragmentRule.getFragment();
        Bundle args = new Bundle();
        Instrumentation instr = InstrumentationRegistry.getInstrumentation();
...
//            fragment.setDirectoryPass("pass");
    ...
    public void testJacketClick() throws Exception {
        ...
        onView(ViewMatchers.withId(R.id.jacket_view)).perform(click());
        verify(mPresenter).onAlbumPlayAction(anyLong());
    }
