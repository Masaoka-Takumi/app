 ...
 */
public class SearchAlbumSongsFragmentTest {
    @Rule public MockitoRule mMockito = MockitoJUnit.rule();
    @Rule public FragmentTestRule<SearchAlbumSongsFragment> mFragmentRule = new FragmentTestRule<SearchAlbumSongsFragment>() {
        @Override
        protected SearchAlbumSongsFragment createDialogFragment() {
            MusicParams params = new MusicParams();
            params.pass = "testAlbum";
            params.albumId = 1L;
            return SearchAlbumSongsFragment.newInstance(params.toBundle());
        }
    };
    @Mock ComponentFactory mComponentFactory;
    @Mock SearchAlbumSongsPresenter mPresenter;
    ...
    public class TestPresenterModule {
        ...
        @Provides
        public SearchAlbumSongsPresenter provideSearchMusicPresenter() {
            return mPresenter;
        }
    }
    ...
    public void setUp() throws Exception {
        ...
        TestAppComponent appComponent = DaggerSearchAlbumSongsFragmentTest_TestAppComponent.builder().build();
        ...
        when(mComponentFactory.getPresenterComponent(appComponent, SearchAlbumSongsFragment.class)).thenReturn(presenterComponent);
        when(mComponentFactory.createFragmentComponent(any(TestPresenterComponent.class), any(SearchAlbumSongsFragment.class))).thenReturn(fragmentComponent);
    ...
    public void testSelectSong() throws Exception {
        mFragmentRule.launchActivity(null);
        final SearchAlbumSongsFragment fragment = mFragmentRule.getFragment();
        ...
        verify(mPresenter).onAlbumSongPlayAction(eq(1L));
    }
}