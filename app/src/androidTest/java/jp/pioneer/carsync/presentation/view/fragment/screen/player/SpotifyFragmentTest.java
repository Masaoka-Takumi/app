...
public class SpotifyFragmentTest {
    @Rule public MockitoRule mMockito = MockitoJUnit.rule();
    @Rule public FragmentTestRule<SpotifyFragment> mFragmentRule = new FragmentTestRule<SpotifyFragment>() {
        private SpotifyFragment mFragment;

        @Override
        protected SpotifyFragment createDialogFragment() {
            // 非UIスレッドから呼ばれるが、GestureDetectorがUIスレッドでインスタンス化しないとだめ
            Instrumentation instr = InstrumentationRegistry.getInstrumentation();
            instr.runOnMainSync(() -> mFragment = new SpotifyFragment());
            return mFragment;
        }
    };
    @Mock ComponentFactory mComponentFactory;
    @Mock SpotifyPresenter mPresenter;
    ...
    public interface TestAppComponent extends AppComponent {
        SpotifyFragmentTest.TestPresenterComponent presenterComponent(SpotifyFragmentTest.TestPresenterModule module);
    }

    @PresenterLifeCycle
    @Subcomponent(modules = SpotifyFragmentTest.TestPresenterModule.class)
    ...
    public class TestPresenterModule {
        ...
        @Provides
        public SpotifyPresenter provideContactsPresenter() {
            return mPresenter;
        }
    }
    ...
    public void setUp() throws Exception {
        ...
        SpotifyFragmentTest.TestAppComponent appComponent = DaggerSpotifyFragmentTest_TestAppComponent.builder().build();
        testApp.setAppComponent(appComponent);
        testApp.setComponentFactory(mComponentFactory);
        SpotifyFragmentTest.TestPresenterComponent presenterComponent = appComponent.presenterComponent(new SpotifyFragmentTest.TestPresenterModule());
        FragmentComponent fragmentComponent = presenterComponent.fragmentComponent(new FragmentModule());
        when(mComponentFactory.getPresenterComponent(appComponent, SpotifyFragment.class)).thenReturn(presenterComponent);
        when(mComponentFactory.createFragmentComponent(any(SpotifyFragmentTest.TestPresenterComponent.class), any(SpotifyFragment.class))).thenReturn(fragmentComponent);
    ...
    public void testNewInstance() throws Exception {
        ...
        final SpotifyFragment fragment = mFragmentRule.getFragment();
        Instrumentation instr = InstrumentationRegistry.getInstrumentation();
        instr.runOnMainSync(() -> {
            Bundle args = new Bundle();
            SpotifyFragment m_fragment;
    ...
    public void testOnFlickLeft() throws Exception {
        ...
        final SpotifyFragment fragment = mFragmentRule.getFragment();
        Instrumentation instr = InstrumentationRegistry.getInstrumentation();
        instr.runOnMainSync(() -> fragment.setColor(R.color.ui_color_aqua));
    ...
    public void testOnTouchJacketView() throws Exception {
        ...
        Instrumentation instr = InstrumentationRegistry.getInstrumentation();
        instr.runOnMainSync(() -> fragment.setColor(R.color.ui_color_aqua));
        SpotifyMediaInfo info = new SpotifyMediaInfo();
        info.playbackMode = PlaybackMode.PLAY;
        when(mPresenter.getSpotifyMediaInfo()).thenReturn(info);
//        onView(withId(R.id.jacket_view)).perform(click());
    ...
    public void testSetPlayingTrackSource() throws Exception {
        ...
        instr.runOnMainSync(() -> {
            fragment.setColor(R.color.ui_color_aqua);
            fragment.setPlayingTrackSource("playList");
        });
        onView(withId(R.id.music_info_text)).check(matches(withText("playList")));
    }
    ...
    public void testSetThumbStatusNone() throws Exception {
        ...
        instr.runOnMainSync(() -> {
            fragment.setColor(R.color.ui_color_aqua);
            fragment.setModeView(true);
            fragment.setThumbStatus(ThumbStatus.NONE);
        });
        onView(withId(R.id.thumb_up_button)).check(matches(withDrawable(R.drawable.p0323_iconbtn_1nrm)));
        onView(withId(R.id.thumb_down_button)).check(matches(withDrawable(R.drawable.p0324_iconbtn_1nrm)));
    }
    ...
    public void testSetThumbStatusUp() throws Exception {
        ...
        instr.runOnMainSync(() -> {
            fragment.setColor(R.color.ui_color_aqua);
            fragment.setModeView(true);
            fragment.setThumbStatus(ThumbStatus.UP);
        });
        onView(withId(R.id.thumb_up_button)).perform(click());
        onView(withId(R.id.thumb_up_button)).check(matches(withDrawable(R.drawable.p0323_iconbtn_2slc)));
        onView(withId(R.id.thumb_down_button)).check(matches(withDrawable(R.drawable.p0324_iconbtn_1nrm)));
    }
    ...
    public void testSetThumbStatusDown() throws Exception {
        ...
        instr.runOnMainSync(() -> {
            fragment.setColor(R.color.ui_color_aqua);
            fragment.setModeView(true);
            fragment.setThumbStatus(ThumbStatus.DOWN);
        });
        onView(withId(R.id.thumb_down_button)).perform(click());
        onView(withId(R.id.thumb_up_button)).check(matches(withDrawable(R.drawable.p0323_iconbtn_1nrm)));
        onView(withId(R.id.thumb_down_button)).check(matches(withDrawable(R.drawable.p0324_iconbtn_2slc)));
    }
    ...
    /**
     * Browsing Mode/Radio Modeの切り替えのテスト Radio Modeの場合
     */
    @Test
    public void testSetModeViewRadio() throws Exception {
        mFragmentRule.launchActivity(null);
        final SpotifyFragment fragment = mFragmentRule.getFragment();
        Instrumentation instr = InstrumentationRegistry.getInstrumentation();
        instr.runOnMainSync(() -> {
        ...
        onView(withId(R.id.shuffle_button)).check(matches(not(isDisplayed())));
        onView(withId(R.id.repeat_button)).check(matches(not(isDisplayed())));
        onView(withId(R.id.thumb_up_button)).check(matches(isDisplayed()));
        onView(withId(R.id.thumb_down_button)).check(matches(isDisplayed()));
    }

    /**
     * Browsing Mode/Radio Modeの切り替えのテスト Browsing Modeの場合
     */
    @Test
    public void testSetModeViewBrowsing() throws Exception {
        mFragmentRule.launchActivity(null);
        final SpotifyFragment fragment = mFragmentRule.getFragment();
        Instrumentation instr = InstrumentationRegistry.getInstrumentation();
        instr.runOnMainSync(() -> {
        ...
        onView(withId(R.id.shuffle_button)).check(matches(isDisplayed()));
        onView(withId(R.id.repeat_button)).check(matches(isDisplayed()));
        onView(withId(R.id.thumb_up_button)).check(matches(not(isDisplayed())));
        onView(withId(R.id.thumb_down_button)).check(matches(not(isDisplayed())));
    }
}