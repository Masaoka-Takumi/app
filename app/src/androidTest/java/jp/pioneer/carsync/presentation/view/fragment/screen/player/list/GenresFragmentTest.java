 ...
 * GenresFragmentのテスト
 */
public class GenresFragmentTest {
    ...
    public interface TestAppComponent extends AppComponent {
        GenresFragmentTest.TestPresenterComponent presenterComponent(GenresFragmentTest.TestPresenterModule module);
    }

    @PresenterLifeCycle
    @Subcomponent(modules = GenresFragmentTest.TestPresenterModule.class)
    ...
    public void setUp() throws Exception {
        ...
        GenresFragmentTest.TestAppComponent appComponent = DaggerGenresFragmentTest_TestAppComponent.builder().build();
        testApp.setAppComponent(appComponent);
        testApp.setComponentFactory(mComponentFactory);
        GenresFragmentTest.TestPresenterComponent presenterComponent = appComponent.presenterComponent(new GenresFragmentTest.TestPresenterModule());
        ...
        when(mComponentFactory.createFragmentComponent(any(GenresFragmentTest.TestPresenterComponent.class), any(GenresFragment.class))).thenReturn(fragmentComponent);
    ...
    public void testSetAlbumCursor() throws Exception {
        ...
        instr.runOnMainSync(() -> fragment.setGenreCursor(mCursor, args));
        onView(withText("tanaka")).check(matches(isDisplayed()));
    }

    @Test
    public void testSetAlbumCursor2() throws Exception {
        when(mPresenter.isGenreCardEnabled()).thenReturn(true);
        mFragmentRule.launchActivity(null);
        final GenresFragment fragment = mFragmentRule.getFragment();
        Bundle args = new Bundle();
        Instrumentation instr = InstrumentationRegistry.getInstrumentation();
    ...
    @Test
    public void testSetAlbumCursor3() throws Exception {
        when(mPresenter.isGenreCardEnabled()).thenReturn(true);
        mFragmentRule.launchActivity(null);
        final GenresFragment fragment = mFragmentRule.getFragment();
        Bundle args = new Bundle();
