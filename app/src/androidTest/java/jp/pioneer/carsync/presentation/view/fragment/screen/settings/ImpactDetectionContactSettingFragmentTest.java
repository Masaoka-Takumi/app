...
/**
 * 衝突検知機能設定 緊急連絡先設定の画面のテスト
 */
public class ImpactDetectionContactSettingFragmentTest {
    @Rule public MockitoRule mMockito = MockitoJUnit.rule();
    @Rule public FragmentTestRule<ImpactDetectionContactSettingFragment> mFragmentRule = new FragmentTestRule<ImpactDetectionContactSettingFragment>() {
        @Override
        protected ImpactDetectionContactSettingFragment createDialogFragment() {
            return ImpactDetectionContactSettingFragment.newInstance(Bundle.EMPTY);
        }
    };
    @Mock ComponentFactory mComponentFactory;
    @Mock ImpactDetectionContactSettingPresenter mPresenter;
    /** 仮想的に作成するDBのカラム名 */
    ...
    public class TestPresenterModule {
        ...
        @Provides
        public ImpactDetectionContactSettingPresenter provideImpactDetectionContactSettingPresenter() {
            return mPresenter;
        }
    }
    ...
    public void setUp() throws Exception {
        ...
        TestAppComponent appComponent = DaggerImpactDetectionContactSettingFragmentTest_TestAppComponent.builder().build();
        ...
        when(mComponentFactory.getPresenterComponent(appComponent, ImpactDetectionContactSettingFragment.class)).thenReturn(presenterComponent);
        when(mComponentFactory.createFragmentComponent(any(TestPresenterComponent.class), any(ImpactDetectionContactSettingFragment.class))).thenReturn(fragmentComponent);
    ...
    public void testNewInstance() throws Exception {
        ...
        final ImpactDetectionContactSettingFragment fragment = mFragmentRule.getFragment();
        Instrumentation instr = InstrumentationRegistry.getInstrumentation();
        instr.runOnMainSync(() -> {
            Bundle args = new Bundle();
            ImpactDetectionContactSettingFragment m_fragment;
