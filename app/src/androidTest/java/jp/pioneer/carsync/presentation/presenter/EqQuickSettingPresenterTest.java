 ...
 */
public class EqQuickSettingPresenterTest {
    @Rule public MockitoRule mMockito = MockitoJUnit.rule();
    @InjectMocks EqQuickSettingPresenter mPresenter = new EqQuickSettingPresenter();
    @Mock EqQuickSettingView mView;
    ...
    private CustomEqType mCustomType = CUSTOM1;
