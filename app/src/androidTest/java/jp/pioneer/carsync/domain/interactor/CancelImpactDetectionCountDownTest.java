 ...
 */
public class CancelImpactDetectionCountDownTest {
    @Rule public MockitoRule mMockito = MockitoJUnit.rule();
    @InjectMocks CancelImpactDetectionCountDown mCancelImpactDetectionCountDown;
    ...
    public void execute() throws Exception {
        ...
        // exercise
        mCancelImpactDetectionCountDown.execute();
        mSignal.await();

        // verify
        verify(mCarDevice).impactDetectionCountdown(0);
    }
