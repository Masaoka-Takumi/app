...
public class CarouselViewPager extends ViewPager implements OnTouchListener {
    ...
    public CarouselViewPager(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPageContentWidthId = mResources.getIdentifier("source_select_page_content_width", "dimen",
                mPackageName);
        mPageContentHeightId = mResources.getIdentifier("source_select_page_content_height", "dimen",
                mPackageName);
        mPageContentWidth = getPageContentWidth();
        mPageContentHeight = getPageContentHeight();
    ...
    public void setPageContentWidthId(int pageContentWidthId) {
        mPageContentWidthId = pageContentWidthId;
    }

    public void setPageContentHeightId(int pageContentHeightId) {
        mPageContentHeightId = pageContentHeightId;
    }

    public void setPageContentWidth(int pageContentWidth) {
        mPageContentWidth = pageContentWidth;
    }

    public void setPageContentHeight(int pageContentHeight) {
        mPageContentHeight = pageContentHeight;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mConfig.orientation == CarouselConfig.VERTICAL) {
            int pageContentWidth = mPageContentWidth;
            int newWidth = width;
            ...
            int pageContentHeight = mPageContentHeight;
    ...
    private boolean calculatePageLimitAndMargin() {
        ...
        if (mConfig.orientation == CarouselConfig.HORIZONTAL) {
            contentSize = mPageContentWidth;
        } else {
            contentSize = mPageContentHeight;
        }
