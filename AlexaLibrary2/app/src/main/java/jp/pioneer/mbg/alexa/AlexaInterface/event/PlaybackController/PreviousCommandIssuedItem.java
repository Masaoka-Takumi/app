...
public class PreviousCommandIssuedItem extends AlexaIfPlaybackControllerItem {

    public PreviousCommandIssuedItem(){
        super(Constant.EVENT_PREVIOUS_COMMAND_ISSUED);
    }
