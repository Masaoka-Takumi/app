...
public class PlaybackStutterStartedItem extends AlexaIfAudioPlayerItem {

    private String token;
    private long offsetInMilliseconds;

    public PlaybackStutterStartedItem(String token, long offsetInMilliseconds){
        super(Constant.EVENT_PLAYBACK_SHUTTER_STARTED);
        this.token = token;
