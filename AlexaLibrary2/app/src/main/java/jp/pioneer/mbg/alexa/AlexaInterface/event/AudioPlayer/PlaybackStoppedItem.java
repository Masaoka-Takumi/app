...
public class PlaybackStoppedItem extends AlexaIfAudioPlayerItem {

    private String token;
    private long offsetInMilliseconds;

    public PlaybackStoppedItem(String token, long offsetInMilliseconds){
        super(Constant.EVENT_PLAYBACK_STOPPED);
        this.token = token;
