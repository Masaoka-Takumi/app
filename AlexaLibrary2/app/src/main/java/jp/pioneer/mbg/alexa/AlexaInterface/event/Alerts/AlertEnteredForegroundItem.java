...
public class AlertEnteredForegroundItem extends AlexaIfAlertsItem {

    private String token;

    public AlertEnteredForegroundItem(String token){
        super(Constant.EVENT_ALERT_ENTERED_FOREGROUND);
        this.token = token;
    }
