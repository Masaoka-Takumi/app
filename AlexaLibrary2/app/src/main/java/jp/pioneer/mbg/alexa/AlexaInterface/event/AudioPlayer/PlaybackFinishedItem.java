...
public class PlaybackFinishedItem extends AlexaIfAudioPlayerItem {

    private String token;
    private long offsetInMilliseconds;

    public PlaybackFinishedItem(String token, long offsetInMilliseconds){
        super(Constant.EVENT_PLAYBACK_FINISHED);
        this.token = token;
