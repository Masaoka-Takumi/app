...
public class PlaybackStutterFinishedItem extends AlexaIfAudioPlayerItem {

    private String token;
    private long offsetInMilliseconds;

    public PlaybackStutterFinishedItem(String token, long offsetInMilliseconds){
        super(Constant.EVENT_PLAYBACK_SHUTTER_FINISHED);
        this.token = token;
