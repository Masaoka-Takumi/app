...
public final class CssParserTest {
  ...
  public void testStyleScoreSystem() {
    ...
    style.setTargetVoice("Manuel Cr叩neo");
    assertThat(style.getSpecificityScore("", "b",
        new String[]{"class1", "class2", "class3"}, "Manuel Cr叩neo")).isEqualTo(14);
    // Voice mismatch.
    ...
    assertThat(style.getSpecificityScore("id", "b",
        new String[]{"class1", "class2", "class3"}, "Manuel Cr叩neo")).isEqualTo(0x40000000 + 14);
    // Id mismatch.
