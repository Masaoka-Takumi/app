...
public class MediaCodecAudioRenderer extends MediaCodecRenderer implements MediaClock {
  ...
  public MediaCodecAudioRenderer(
    ...
    boolean bWeblink = pref.getBoolean("weblink", false);

    if (bWeblink) {
      this.audioSink = new WeblinkAudioSink(audioCapabilities, audioProcessors);
    } else {
      this.audioSink = new DefaultAudioSink(audioCapabilities, audioProcessors);
    }
