...
public class SimpleExoPlayer implements ExoPlayer, Player.VideoComponent, Player.TextComponent {
  ...
  protected SimpleExoPlayer(
    ...
    player = createExoPlayerImpl(name, renderers, trackSelector, loadControl, clock);
  ...
  protected ExoPlayer createExoPlayerImpl(
      String name, Renderer[] renderers, TrackSelector trackSelector, LoadControl loadControl, Clock clock) {
    return new ExoPlayerImpl(name, renderers, trackSelector, loadControl, clock);
  }
