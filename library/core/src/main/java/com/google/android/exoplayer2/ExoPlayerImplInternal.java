...
/* package */ final class ExoPlayerImplInternal
  ...
  public ExoPlayerImplInternal(
    ...
    internalPlaybackThread = new HandlerThread("ExoPlayerImplInternal:"+name,
  ...
  public synchronized void sendMessage(PlayerMessage message) {
    if (released) {
      Log.w(TAG, name+":Ignoring messages sent after release.");
    ...
    try {
      switch (msg.what) {
        ...
        case MSG_RELEASE:
          ...
          return true;
        default:
          Log.e(TAG, name+":handleMessage: END(false)");
          return false;
      }
      maybeNotifyPlaybackInfoChanged();
    } catch (ExoPlaybackException e) {
      Log.e(TAG, name+":Playback error.", e);
      stopInternal(/* reset= */ false, /* acknowledgeStop= */ false);
      eventHandler.obtainMessage(MSG_ERROR, e).sendToTarget();
      maybeNotifyPlaybackInfoChanged();
    } catch (IOException e) {
      Log.e(TAG, name+":Source error.", e);
      stopInternal(/* reset= */ false, /* acknowledgeStop= */ false);
      eventHandler.obtainMessage(MSG_ERROR, ExoPlaybackException.createForSource(e)).sendToTarget();
      maybeNotifyPlaybackInfoChanged();
    } catch (RuntimeException e) {
      Log.e(TAG, name+":Internal runtime error.", e);
      stopInternal(/* reset= */ false, /* acknowledgeStop= */ false);
        ...
        new Runnable() {
          ...
          public void run() {
            try {
              ...
              Log.e(TAG, name+":Unexpected error delivering message on external thread.", e);
